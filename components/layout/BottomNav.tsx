    ...
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-line/70 bg-background/90 backdrop-blur-xl md:hidden">
      <div className="mx-auto grid max-w-md grid-cols-4 items-center px-2 pb-[env(safe-area-inset-bottom)] pt-2">
        ...
        <Link href="/checkout" className="flex justify-center">
          <span className="animate-shake flex flex-col items-center gap-1 rounded-2xl bg-gold px-4 py-2 text-[0.65rem] font-semibold uppercase tracking-[0.1em] text-background shadow-gold">
